    ...
    <section className="hero" id="home">
      ...
      <div className="hero__content">
        ...
        <div className="hero__actions">
          <button className="hero__cta">Request a private consult</button>
          <button className="hero__secondary">View the portfolio</button>
        </div>
      ...
      <div className="hero__visual">
        <div className="hero__visual-frame">
          <img
            ...
            src="https://images.unsplash.com/photo-1616594039964-40b47c2935f4?auto=format&fit=crop&w=1400&q=80"
